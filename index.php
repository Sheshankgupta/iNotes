...
<div class="container-fluid my-5">
    <form action="save_notes.php" method="POST">
        ...
        <textarea class="form-control mb-3" id="ControlTextarea1" rows="3" name="description" placeholder="this field will hold description for your notes"></textarea>
        <input type="submit" class="btn btn-dark mt-2 form-control">
        <a href="data.php?id=1"><input type="button" class="btn btn-dark mt-2 form-control" value="See Notes"></a>
